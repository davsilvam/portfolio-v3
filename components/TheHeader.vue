  ...
  <header class="fixed top-0 z-10 flex w-full items-center justify-between p-8">
    ...
    <div class="relative">
      <button
        ...
        class="hover:bg-secondary-800/20 ring-secondary-50 flex h-12 w-12 items-center justify-center rounded-full hover:ring-2"
      >
        <IconLanguage class="w-5" />
      </button>
      <nav
        v-if="isTranslateMenuOpen"
        class="text-secondary-50 bg-secondary-800/20 absolute right-2 mt-3 flex w-40 flex-col rounded-md py-3 text-right"
      >
        <NuxtLink
          class="ring-secondary-50 w-full cursor-pointer py-2 px-4 text-sm font-medium"
